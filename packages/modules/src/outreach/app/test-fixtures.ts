...
import type { OutreachCard, OutreachColumn, OutreachContact } from "../domain/index.js";
...
export function makeFakeOutreachContact(overrides: Partial<OutreachContact> = {}): OutreachContact {
  return {
    id: "contact-1",
    organizationId: "org-1",
    name: "Jamie Booker",
