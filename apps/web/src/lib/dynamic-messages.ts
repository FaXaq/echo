...
export const DYNAMIC_MESSAGES: Record<string, MessageDescriptor> = {
  ...
  "Check your email to verify your account": msg`Check your email to verify your account`,
  "Password reset failed": msg`Password reset failed`,
  "Email not verified": msg`Email not verified`,
  "Email verification failed": msg`Email verification failed`,
  "Failed to send verification code": msg`Failed to send verification code`,
  "Enter the 6-digit code": msg`Enter the 6-digit code`,
  "A new code has been sent": msg`A new code has been sent`,
  "OTP expired": msg`This code has expired, request a new one`,
  "Invalid OTP": msg`Invalid code`,
  "Too many attempts": msg`Too many attempts, request a new code`,
  "You are not the recipient of the invitation": msg`This invitation is not yours`,
  "Failed to accept invitation": msg`Failed to accept invitation`,
