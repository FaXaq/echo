...
export function EventDetail({
  ...
  return (
    <div data-slot="event-detail" className={cn("flex flex-col gap-6", className)}>
      ...
      <div className="flex flex-col gap-3">
        <div className="flex items-center gap-2">
          <span className={cn("size-2.5 rounded-full", eventDotClasses[event.color])} />
          <span className="text-sm text-muted-foreground">{t(COLOR_LABELS[event.color])}</span>
          {event.type && (
